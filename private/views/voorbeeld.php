<div class="container">
    ...
    <p>Vul hier de zoekopdracht in voor een film titel, dit voorbeeld roept de <a href="https://omdbapi.com" target="_blank">OMDBAPI</a> aan</p>
        ...
        <div class="row">
            <?php foreach ($data['Search'] as $result): ?>
                <div class="col-12 col-sm-6 col-md-4">
                    ...
                    <p><a href="https://www.imdb.com/title/<?php echo $result['imdbID'] ?>" target="_blank">Bekijk op
                            IMDB</a></p>
                </div>
            <?php endforeach; ?>
        </div>
